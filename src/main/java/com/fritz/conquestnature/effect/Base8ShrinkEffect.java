...
public class Base8ShrinkEffect extends MobEffect {


    protected Base8ShrinkEffect(MobEffectCategory mobEffectCategory, int color) {
    ...
    public void addAttributeModifiers (LivingEntity entity, AttributeMap attributes, int amplifier) {
        ...
        float newScale = scaleH.getBaseScale() / 8;
        float newWidth = scaleW.getBaseScale() / 8;
        float newSpeed = scaledSpeed.getBaseScale() / 8;
